...
description: Analyze repository structure, conventions, boundaries, dependencies, and change impact without modifying files.
---
...
Analyze repository structure, conventions, boundaries, dependencies, and change impact without modifying files.
...
- task statement
- repository files in authorized scope
