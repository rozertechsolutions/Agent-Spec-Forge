---
name: controlled-refactoring
description: Improve internal design without unintended behavior changes, using explicit invariants and regression evidence.
---
...
Improve internal design without unintended behavior changes, using explicit invariants and regression evidence.

## Use when

- technical debt
- maintainability issue
- approved internal redesign
