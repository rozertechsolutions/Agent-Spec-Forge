...
Delegate exclusive responsibilities through `.codex/agents/*.toml`. Use `.agents/skills/*/SKILL.md` for reusable procedures. Do not use a reviewer to implement the change it reviews.
