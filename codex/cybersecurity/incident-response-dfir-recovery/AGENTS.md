# codex Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `codex/cybersecurity/incident-response-dfir-recovery/`.
