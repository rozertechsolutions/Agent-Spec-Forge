# codex Cybersecurity Security Architecture and Engineering Instructions

These instructions apply only inside `codex/cybersecurity/security-architecture-engineering/`.
