# codex Cybersecurity Defensive Security Operations, Detection, and Intelligence Instructions

These instructions apply only inside `codex/cybersecurity/defensive-security-operations-detection-intelligence/`.
