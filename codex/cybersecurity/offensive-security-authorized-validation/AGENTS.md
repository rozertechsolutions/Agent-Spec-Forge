# codex Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `codex/cybersecurity/offensive-security-authorized-validation/`.
