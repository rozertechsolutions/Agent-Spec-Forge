---
name: marketing-engineering-final-quality-gate
description: "Independently verify scope, contracts, tests, security, privacy, accessibility, observability, rollback, and readiness for a human release decision. Use when the named owner has the required inputs and the result must pass independent review."
---

# Marketing Engineering Final Quality Gate
