---
name: dashboard-and-semantic-metric-engineering
description: "Implement consistent semantic metrics and decision-focused dashboards with ownership, lineage, access, freshness, filters, and validation. Use when the named owner has the required inputs and the result must pass independent review."
---

# Dashboard and Semantic Metric Engineering
...
- source contracts, metric dictionary, grain, keys, freshness, retention, access, and owners.
- lineage, quality thresholds, monitoring, incident, and recovery requirements.
...
## Output contract
- pipeline, semantic metric, dashboard, or quality design.
- schemas, transformations, lineage, tests, alerts, ownership, recovery, and access controls.
