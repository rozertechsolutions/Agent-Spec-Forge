---
name: crm-cms-email-and-cdp-integration
description: "Design least-privilege, idempotent, observable integrations with explicit contracts, preference handling, deletion, testing, and recovery. Use when the named owner has the required inputs and the result must pass independent review."
---

# CRM, CMS, Email, and CDP Integration
