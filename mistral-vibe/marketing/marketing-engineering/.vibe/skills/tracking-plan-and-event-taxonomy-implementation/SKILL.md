---
name: tracking-plan-and-event-taxonomy-implementation
description: "Implement or specify versioned event contracts, identity boundaries, consent gating, validation, monitoring, and rollback. Use when the named owner has the required inputs and the result must pass independent review."
---

# Tracking Plan and Event Taxonomy Implementation
