---
name: landing-page-and-form-engineering
description: "Implement or specify accessible, performant, secure, consent-aware landing pages and forms from approved content and acceptance criteria. Use when the named owner has the required inputs and the result must pass independent review."
---

# Landing Page and Form Engineering
...
This procedure uses only the native mechanisms configured for `mistral-vibe-code`.
...
3. Confirm approved content, site scope, target indexation, environment, data purpose, analytics contract, performance budget, and rollback owner.
4. Implement or specify semantic, accessible, responsive, secure, performant behavior without altering approved claims or using manipulative techniques.
5. Validate forms, metadata, crawl/index signals, redirects, rendering, structured data, keyboard use, errors, privacy, and representative performance.
6. Prepare bounded release and rollback instructions for human execution; do not deploy production changes.
