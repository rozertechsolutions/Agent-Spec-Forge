---
name: data-layer-and-tag-manager-engineering
description: "Design governed data-layer contracts and tag-manager behavior with ownership, purpose, consent gating, environments, versioning, tests, and rollback. Use when the named owner has the required inputs and the result must pass independent review."
---

# Data Layer and Tag Manager Engineering
...
## Output contract
- versioned event/data-layer contract and mapping.
- implementation or specification, validation evidence, monitoring, discrepancy log, and rollback.
