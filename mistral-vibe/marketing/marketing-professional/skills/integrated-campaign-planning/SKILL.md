---
name: integrated-campaign-planning
description: "Create a coordinated campaign plan linking objective, audience, message, channels, assets, timing, budget scenarios, measurement, and approval. Use when the named owner has the required inputs and the result must pass independent review."
---
