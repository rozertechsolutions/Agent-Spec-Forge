---
name: audience-segmentation-and-persona-development
description: "Create evidence-based, actionable, non-discriminatory segments and practical personas without inventing sensitive traits. Use when the named owner has the required inputs and the result must pass independent review."
---
