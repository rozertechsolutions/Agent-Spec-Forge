---
name: localization-and-market-adaptation-review
description: "Adapt and review marketing artifacts for language, culture, market availability, formats, terminology, policy, and local risk. Use when the named owner has the required inputs and the result must pass independent review."
---

# Localization and Market Adaptation Review
...
This procedure uses only the native mechanisms configured for `mistral-vibe-work`.

## Required inputs
- approved objective and scope.
- accountable owner and approval authority.
- constraints, deadline, and acceptance criteria.
- approved product facts, claim evidence, audience, message hierarchy, brand voice, channel, and locale.
- rights, disclosures, accessibility, and policy requirements.
...
3. Lock approved product facts, audience, message hierarchy, evidence, brand constraints, channel rules, locale, and accessibility needs.
4. Create the requested artifact without changing approved meaning, fabricating proof, hiding disclosures, or reproducing protected work without rights.
5. Annotate material claims, rights, disclosures, channel constraints, localization decisions, and review requirements.
6. Check clarity, consistency, accessibility, cultural risk, platform policy, and readiness for human editorial approval.
...
## Output contract
- review-ready draft or plan.
- claim/evidence annotations, rights/disclosures, accessibility/localization notes, and review status.
