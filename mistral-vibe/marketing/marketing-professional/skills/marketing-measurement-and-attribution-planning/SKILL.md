---
name: marketing-measurement-and-attribution-planning
description: "Define decision-linked KPIs, metric contracts, event requirements, attribution assumptions, reporting, and uncertainty before execution. Use when the named owner has the required inputs and the result must pass independent review."
---

# Marketing Measurement and Attribution Planning
