---
name: marketing-copy-production
description: "Produce channel-ready copy drafts from approved facts while preserving evidence, disclosures, brand voice, accessibility, and traceability. Use when the named owner has the required inputs and the result must pass independent review."
---
