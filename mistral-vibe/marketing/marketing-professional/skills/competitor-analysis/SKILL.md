...
description: "Compare competitors through a consistent framework using verifiable public evidence without impersonation or intrusion. Use when the named owner has the required inputs and the result must pass independent review."
---
