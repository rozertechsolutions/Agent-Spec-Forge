...
description: "Produce a channel-specific social plan with justified roles, pillars, calendar, formats, community protocol, escalation, and metrics. Use when the named owner has the required inputs and the result must pass independent review."
---
