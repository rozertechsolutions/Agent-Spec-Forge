...
description: "Analyze validated campaign data with declared comparisons, attribution limits, uncertainty, and bounded recommendations. Use when the named owner has the required inputs and the result must pass independent review."
---
