---
name: email-and-lifecycle-campaign-planning
description: "Design consent-aware segments, sequences, triggers, frequency, suppression, copy requirements, tests, and measurement without sending. Use when the named owner has the required inputs and the result must pass independent review."
---

# Email and Lifecycle Campaign Planning
