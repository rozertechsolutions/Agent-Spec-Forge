# mistral-vibe Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `mistral-vibe/cybersecurity/offensive-security-authorized-validation/`.
