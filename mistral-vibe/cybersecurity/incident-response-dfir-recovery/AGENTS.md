# mistral-vibe Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `mistral-vibe/cybersecurity/incident-response-dfir-recovery/`.
