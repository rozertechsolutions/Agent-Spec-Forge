# mistral-vibe Cybersecurity Application, Product, and DevSecOps Security Instructions

These instructions apply only inside `mistral-vibe/cybersecurity/application-product-devsecops-security/`.
