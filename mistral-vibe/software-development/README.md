...
This directory implements the Software Development specialization for Mistral Vibe using only platform-appropriate, repository-scoped content.
...
- AGENTS.md
- .vibe/config.toml project configuration
- .vibe/agents agents
- .vibe/prompts role prompts
- .vibe/skills Skills
...
- hooks
- MCP configuration
- model/provider/endpoint pinning
