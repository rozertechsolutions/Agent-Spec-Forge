---
description: "user-invoked Security Architecture and Engineering workflow for `identity-cloud-network-data-design`. This command is a prompt artifact only and is not executed during repository implementation."
---

# /identity-cloud-network-data-design

Purpose: user-invoked Security Architecture and Engineering workflow for `identity-cloud-network-data-design`. This command is a prompt artifact only and is not executed during repository implementation.

Authorized scope: static repository files and supplied redacted evidence for `security-architecture-engineering`.
...
2. Invoke the relevant Skill from: security-architecture-review, reference-and-control-patterns, identity-cloud-network-data-design, container-iac-automation-review, independent-architecture-assurance.
3. Assign one primary owner from: architecture-governance-agent, enterprise-solution-architecture-agent, identity-cloud-network-agent, data-container-automation-agent, independent-architecture-reviewer.
