---
description: "Run Technical SEO Remediation with mandatory stage gates and human approval."
subtask: true
---
...
## Stages
1. **Validate site scope and indexation intent.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
2. **Audit crawl, index, render, and performance.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
3. **Prioritize findings.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
4. **Implement or specify changes.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
5. **Validate and define post-release checks.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
6. **Prepare rollback.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
