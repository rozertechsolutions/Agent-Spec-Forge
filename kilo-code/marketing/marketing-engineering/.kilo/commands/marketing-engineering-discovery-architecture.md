---
description: "Run Marketing Engineering Discovery & Architecture with mandatory stage gates and human approval."
subtask: true
---

# Marketing Engineering Discovery & Architecture
...
## Stages
1. **Validate handoff.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
2. **Inventory systems, data, environments, and owners.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
3. **Model data flows and trust boundaries.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
4. **Define architecture, acceptance tests, rollback, and access.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
5. **Privacy/security review.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
6. **Human scope approval.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
