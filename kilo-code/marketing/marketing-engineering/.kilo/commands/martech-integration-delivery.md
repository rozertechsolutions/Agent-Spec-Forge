---
description: "Run Martech Integration Delivery with mandatory stage gates and human approval."
subtask: true
---

# Martech Integration Delivery
...
## Stages
1. **Validate purpose and owners.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
2. **Define contracts, identities, preferences, deletion, and scopes.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
3. **Implement or specify idempotency, retries, and observability.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
4. **Test mapping, failures, replay, opt-out, and deletion.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
5. **Security/privacy review.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
6. **Runbook and rollback.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
7. **Prepare activation approval.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
