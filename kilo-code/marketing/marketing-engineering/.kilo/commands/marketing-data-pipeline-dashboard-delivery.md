---
description: "Run Marketing Data Pipeline and Dashboard Delivery with mandatory stage gates and human approval."
subtask: true
---

# Marketing Data Pipeline and Dashboard Delivery
...
## Stages
1. **Validate contracts, metrics, and access.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
2. **Implement or specify ingestion and transformation.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
3. **Add lineage and quality tests.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
4. **Build semantic metrics and dashboard.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
5. **Validate reconciliation, freshness, and privacy.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
6. **Add monitoring and recovery.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
7. **Independent QA.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
8. **Human access/release approval.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
