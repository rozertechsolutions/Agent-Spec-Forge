---
description: "Run Final Technical Release Approval Preparation with mandatory stage gates and human approval."
subtask: true
---

# Final Technical Release Approval Preparation
...
## Stages
1. **Trace requirements to implementation and tests.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
2. **Verify security, privacy, accessibility, and performance.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
3. **Confirm observability and rollback.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
4. **Reconcile findings and scope changes.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
5. **Verify no secrets or production actions occurred.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
6. **Set readiness state and requested human decision.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
