---
description: "Run Localization & International Release with mandatory stage gates and human approval."
subtask: true
---

# Localization & International Release
...
## Stages
1. **Confirm source intent and market availability.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
2. **Adapt language, culture, terminology, formats, and disclosures.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
3. **Check product, channel, and policy context.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
4. **Qualified local review.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
5. **Compliance review.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
6. **Independent review.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
7. **Prepare local release approval.** Capture owner, inputs, output, evidence, checks, risk, and state. Do not advance while a blocker remains.
