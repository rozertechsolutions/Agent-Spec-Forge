...
Connectors are optional, manually authorized, least-privileged, and disabled by default. Do not assume connector availability. Never make a write or external action without explicit human confirmation for the exact target and payload.
