# /application-product-devsecops-security-manual-workflow

Purpose: user-invoked Application, Product, and DevSecOps Security workflow for `application-product-devsecops-security-manual-workflow`. This command is a prompt artifact only and is not executed during repository implementation.
