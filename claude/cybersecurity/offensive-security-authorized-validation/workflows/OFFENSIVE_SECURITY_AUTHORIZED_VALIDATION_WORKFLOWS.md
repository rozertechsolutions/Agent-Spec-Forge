# /offensive-security-authorized-validation-manual-workflow

Purpose: user-invoked Offensive Security Authorized Validation workflow for `offensive-security-authorized-validation-manual-workflow`. This command is a prompt artifact only and is not executed during repository implementation.
