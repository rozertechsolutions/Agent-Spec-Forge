# claude Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `claude/cybersecurity/offensive-security-authorized-validation/`.
