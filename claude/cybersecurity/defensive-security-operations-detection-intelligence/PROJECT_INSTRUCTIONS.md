# claude Cybersecurity Defensive Security Operations, Detection, and Intelligence Instructions

These instructions apply only inside `claude/cybersecurity/defensive-security-operations-detection-intelligence/`.
