# /defensive-security-operations-detection-intelligence-manual-workflow

Purpose: user-invoked Defensive Security Operations, Detection, and Intelligence workflow for `defensive-security-operations-detection-intelligence-manual-workflow`. This command is a prompt artifact only and is not executed during repository implementation.
