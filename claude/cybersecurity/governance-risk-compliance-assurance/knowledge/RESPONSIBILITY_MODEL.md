# claude Cybersecurity Governance, Risk, Compliance, and Assurance Instructions

These instructions apply only inside `claude/cybersecurity/governance-risk-compliance-assurance/`.
