# /governance-risk-compliance-assurance-manual-workflow

Purpose: user-invoked Governance, Risk, Compliance, and Assurance workflow for `governance-risk-compliance-assurance-manual-workflow`. This command is a prompt artifact only and is not executed during repository implementation.
