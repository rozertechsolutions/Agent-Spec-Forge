# claude Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `claude/cybersecurity/incident-response-dfir-recovery/`.
