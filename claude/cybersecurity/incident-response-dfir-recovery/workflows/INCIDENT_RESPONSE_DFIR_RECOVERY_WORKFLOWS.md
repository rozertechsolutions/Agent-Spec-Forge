# /incident-response-dfir-recovery-manual-workflow

Purpose: user-invoked Incident Response, DFIR, and Recovery workflow for `incident-response-dfir-recovery-manual-workflow`. This command is a prompt artifact only and is not executed during repository implementation.
