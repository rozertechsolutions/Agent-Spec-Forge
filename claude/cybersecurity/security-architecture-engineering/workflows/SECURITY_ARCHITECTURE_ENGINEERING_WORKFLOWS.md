# /security-architecture-engineering-manual-workflow

Purpose: user-invoked Security Architecture and Engineering workflow for `security-architecture-engineering-manual-workflow`. This command is a prompt artifact only and is not executed during repository implementation.
