# claude Cybersecurity Security Architecture and Engineering Instructions

These instructions apply only inside `claude/cybersecurity/security-architecture-engineering/`.
