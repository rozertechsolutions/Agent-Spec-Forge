# claude Cybersecurity Cyber Resilience and Specialized Technologies Instructions

These instructions apply only inside `claude/cybersecurity/cyber-resilience-specialized-technologies/`.
