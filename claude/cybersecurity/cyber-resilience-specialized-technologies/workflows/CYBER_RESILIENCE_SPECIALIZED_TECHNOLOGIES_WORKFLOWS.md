# /cyber-resilience-specialized-technologies-manual-workflow

Purpose: user-invoked Cyber Resilience and Specialized Technologies workflow for `cyber-resilience-specialized-technologies-manual-workflow`. This command is a prompt artifact only and is not executed during repository implementation.
