# opencode Cybersecurity Defensive Security Operations, Detection, and Intelligence Instructions

These instructions apply only inside `opencode/cybersecurity/defensive-security-operations-detection-intelligence/`.
