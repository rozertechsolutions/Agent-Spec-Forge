# opencode Cybersecurity Application, Product, and DevSecOps Security Instructions

These instructions apply only inside `opencode/cybersecurity/application-product-devsecops-security/`.
