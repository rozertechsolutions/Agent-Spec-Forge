# opencode Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `opencode/cybersecurity/incident-response-dfir-recovery/`.
