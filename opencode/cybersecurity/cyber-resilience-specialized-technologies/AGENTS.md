# opencode Cybersecurity Cyber Resilience and Specialized Technologies Instructions

These instructions apply only inside `opencode/cybersecurity/cyber-resilience-specialized-technologies/`.
