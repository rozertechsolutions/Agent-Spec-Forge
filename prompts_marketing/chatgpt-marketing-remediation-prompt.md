# AI Specialized Departments — ChatGPT Marketing Remediation Prompt

## Mission

Correct only the Marketing specialization for `chatgpt/` in the existing
...
1. Inventory every file under `chatgpt/marketing/`.
...
Redundant setup/governance files, generic workflows outside the knowledge area, inaccurate subagent implications, and unsafe approval-state semantics.

## Deletion allowlist

- `chatgpt/marketing/AUDIT.md`
- `chatgpt/marketing/marketing-professional/SETUP.md`
- `chatgpt/marketing/marketing-engineering/SETUP.md`
- `chatgpt/marketing/marketing-professional/reference/GOVERNANCE.md`
- `chatgpt/marketing/marketing-engineering/reference/GOVERNANCE.md`
- `chatgpt/marketing/marketing-professional/workflows/`
- `chatgpt/marketing/marketing-engineering/workflows/`
...
- Move every existing branch workflow document into the corresponding
  `knowledge/workflows/` directory before deleting the original `workflows/` directory.
- Merge any unique `SETUP.md` information into the branch `INSTALLATION.md` before
  deleting `SETUP.md`.

## Required modifications

- Keep `PROJECT_INSTRUCTIONS.md`, Skills, knowledge files, role profiles, templates,
  schemas, catalogs, and installation documentation.
- Keep `knowledge/GOVERNANCE.md` as the sole governance document in each branch and
  update every reference to it.
- Describe role files accurately as Project/GPT knowledge profiles, not isolated native
  subagents.
- State that independent final review requires a separate chat/session or an authorized
  human reviewer.
- Do not add repository subagents, shell permissions, hooks, local MCP configuration, or
  automatic publication/actions.
- Ensure Skills are packaged in the current ChatGPT Skill format and installation
  documentation explains plan/workspace availability without claiming universal access.

## Platform-specific acceptance criteria

- Both `chatgpt/marketing/marketing-professional/` and
  `chatgpt/marketing/marketing-engineering/` remain present and independently usable.
