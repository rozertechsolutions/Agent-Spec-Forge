# Installation and Acceptance — kiro / marketing-professional

This is a manual, review-first installation. The package contains no installer and performs no action by itself.

## Installation
1. Copy `.kiro/steering/` and `.kiro/specs/` to the target project root after review.
2. Select only the relevant spec and complete its requirements, design, and task gates.
3. Do not treat checked tasks as production approval.
