...
This directory implements the Software Development specialization for Gemini CLI using only platform-appropriate, repository-scoped content.
...
- .gemini/agents local subagents
- .gemini/skills Skills
- .gemini/commands prompt-only custom commands
- .gemini/policies declarative command policy
