# cline Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `cline/cybersecurity/incident-response-dfir-recovery/`.
