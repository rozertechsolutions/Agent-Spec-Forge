# cline Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `cline/cybersecurity/offensive-security-authorized-validation/`.
