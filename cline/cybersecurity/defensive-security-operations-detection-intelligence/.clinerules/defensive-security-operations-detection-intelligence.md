# cline Cybersecurity Defensive Security Operations, Detection, and Intelligence Instructions

These instructions apply only inside `cline/cybersecurity/defensive-security-operations-detection-intelligence/`.
