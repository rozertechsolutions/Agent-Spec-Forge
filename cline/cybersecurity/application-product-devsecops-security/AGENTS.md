# cline Cybersecurity Application, Product, and DevSecOps Security Instructions

These instructions apply only inside `cline/cybersecurity/application-product-devsecops-security/`.
