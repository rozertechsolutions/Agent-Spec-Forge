# cline Cybersecurity Security Architecture and Engineering Instructions

These instructions apply only inside `cline/cybersecurity/security-architecture-engineering/`.
