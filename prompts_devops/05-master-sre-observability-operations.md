# Master Implementation Prompt — DevOps and Cloud — 05 SRE, Observability and Operations

You are implementing exactly one validated section of the open-source **AI Specialized Departments** repository.

Your task is to implement **SRE, Observability and Operations** sequentially across the supported platform packages. Work autonomously within the rules below. Do not ask for confirmation unless repository safety makes progress impossible. Do not begin another DevOps and Cloud section.
...
## Section contract
    ...
    **Section:** `05-sre-observability-operations`  
    **Mission:** Establish measurable reliability and operability through service objectives, actionable telemetry, disciplined incident practices and reduction of repetitive manual work.
...
- OpenTelemetry, Prometheus, Grafana, Loki, Tempo, Jaeger, Elastic and OpenSearch where relevant
- Dashboards, alerting, on-call, runbooks and escalation
- Operational incidents, command structures and postmortems
- Problem management, reliability backlogs and toil reduction
- Service ownership and operational readiness
...
- Loki
- Tempo and Jaeger
- Elastic Stack and OpenSearch
- Cloud-native monitoring services
- Incident and on-call platforms as optional disabled integrations
...
- Verify that the content is specific to `SRE, Observability and Operations`, not generic DevOps filler.
...
3. Commit with:
   **`feat(devops-cloud): implement 05 sre observability operations`**
