# Master Implementation Prompt — DevOps and Cloud — 09 FinOps and Sustainability

You are implementing exactly one validated section of the open-source **AI Specialized Departments** repository.

Your task is to implement **FinOps and Sustainability** sequentially across the supported platform packages. Work autonomously within the rules below. Do not ask for confirmation unless repository safety makes progress impossible. Do not begin another DevOps and Cloud section.
...
## Section contract
    ...
    **Section:** `09-finops-sustainability`  
    **Mission:** Maximize technology value through transparent cost and usage decisions while separating technical recommendations from human financial authorization.

    ### Roles and non-overlapping ownership

    | Role | Exclusive ownership |
|---|---|
| `FinOps Engineer` | Owns cost visibility, allocation, forecasting, budgets, anomaly response, unit economics, optimization recommendations and engineering/finance collaboration. |
| `Cloud Sustainability and Efficiency Analyst` | Owns measurable resource-efficiency and sustainability analysis, carbon-aware tradeoffs and evidence-based sustainability recommendations. |
...
- Unit economics and cost per service outcome
- Rightsizing, scheduling, storage lifecycle and commitment analysis
- Shared-cost allocation and chargeback/showback models
- Technology-value tradeoffs and executive strategy alignment
- Measurable sustainability and resource-efficiency indicators
- FinOps Framework 2026 concepts where applicable

    ### Explicit exclusions

    - Approving purchases, budgets, commitments or spending
- Executing resource changes
- Unsupported environmental claims or greenwashing

    ### Technology knowledge to cover without creating one agent per product

    - AWS, Azure and Google Cloud cost-management concepts
- FinOps Open Cost and Usage Specification concepts where useful
- Kubernetes cost allocation
- Cost estimation and anomaly-detection tooling categories
- Carbon and energy metrics only when evidence exists
...
- commitment-analysis
- sustainability-efficiency-review
...
- Verify that the content is specific to `FinOps and Sustainability`, not generic DevOps filler.
...
3. Commit with:
   **`feat(devops-cloud): implement 09 finops sustainability`**
