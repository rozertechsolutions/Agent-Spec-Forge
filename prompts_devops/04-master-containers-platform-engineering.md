# Master Implementation Prompt — DevOps and Cloud — 04 Containers and Platform Engineering

You are implementing exactly one validated section of the open-source **AI Specialized Departments** repository.

Your task is to implement **Containers and Platform Engineering** sequentially across the supported platform packages. Work autonomously within the rules below. Do not ask for confirmation unless repository safety makes progress impossible. Do not begin another DevOps and Cloud section.
...
## Section contract
    ...
    **Section:** `04-containers-platform-engineering`  
    **Mission:** Define portable container and orchestration practices plus an internal platform product that reduces cognitive load without hiding critical operational and security constraints.
...
| `Platform Product and Developer Experience Engineer` | Owns internal developer platform capabilities, golden paths, service catalogs, templates, portals, self-service contracts, developer experience and platform-as-a-product feedback. |
    ...
    - Docker and OCI image design
- Docker Compose for local topology examples where appropriate
- Kubernetes workload, configuration and tenancy patterns
- Helm, Kustomize, registries and image lifecycle
- Internal Developer Platforms, service catalogs and developer portals
- Golden paths, paved roads, templates and controlled self-service
- Platform APIs, product metrics, user research and lifecycle management

    ### Explicit exclusions

    - Running containers or Kubernetes clusters
...
- Backstage-style service catalogs and developer portals
- Crossplane and platform APIs where justified
...
- Verify that the content is specific to `Containers and Platform Engineering`, not generic DevOps filler.
...
3. Commit with:
   **`feat(devops-cloud): implement 04 containers platform engineering`**
