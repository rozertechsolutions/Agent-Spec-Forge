# Master Implementation Prompt — DevOps and Cloud — 03 CI/CD and Release Engineering

You are implementing exactly one validated section of the open-source **AI Specialized Departments** repository.

Your task is to implement **CI/CD and Release Engineering** sequentially across the supported platform packages. Work autonomously within the rules below. Do not ask for confirmation unless repository safety makes progress impossible. Do not begin another DevOps and Cloud section.
...
## Section contract
    ...
    **Section:** `03-ci-cd-release-engineering`  
    **Mission:** Create safe, observable and reversible delivery systems from source change to release without performing actual builds, pipeline runs or deployments.
...
- Build and test stage orchestration
- Artifact repositories, registries, provenance and promotion
- Versioning and environment promotion
- Rolling, blue-green, canary and progressive delivery
- Feature flags, database-change coordination and rollback
- Jenkins, GitHub Actions, GitLab CI/CD, Azure Pipelines, CircleCI, Tekton, Argo CD and Flux where relevant
- DORA delivery and stability metrics
...
- Verify that the content is specific to `CI/CD and Release Engineering`, not generic DevOps filler.
...
3. Commit with:
   **`feat(devops-cloud): implement 03 ci cd release engineering`**
