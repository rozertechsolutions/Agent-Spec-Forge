...
This directory implements the Software Development specialization for GitHub Copilot using only platform-appropriate, repository-scoped content.
...
- .github/instructions path instructions
...
- hooks
- MCP configuration
- automatic commits, pull requests, merges, releases, or deployments
