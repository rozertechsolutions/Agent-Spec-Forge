# Installation and Acceptance — windsurf / marketing-professional

This is a manual, review-first installation. The package contains no installer and performs no action by itself.

## Installation
1. Copy `AGENTS.md` and `.windsurf/` to the target project root after review.
2. Review Skills and invoke workflows individually through the native workflow interface.
3. Confirm tool permissions before Marketing Engineering edits.
