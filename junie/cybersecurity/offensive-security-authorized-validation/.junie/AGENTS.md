# junie Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `junie/cybersecurity/offensive-security-authorized-validation/`.
