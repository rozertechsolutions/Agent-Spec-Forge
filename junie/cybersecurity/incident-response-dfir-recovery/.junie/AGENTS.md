# junie Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `junie/cybersecurity/incident-response-dfir-recovery/`.
