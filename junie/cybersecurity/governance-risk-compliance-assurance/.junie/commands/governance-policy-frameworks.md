---
description: "user-invoked Governance, Risk, Compliance, and Assurance workflow for `governance-policy-frameworks`. This command is a prompt artifact only and is not executed during repository implementation."
---

# /governance-policy-frameworks

Purpose: user-invoked Governance, Risk, Compliance, and Assurance workflow for `governance-policy-frameworks`. This command is a prompt artifact only and is not executed during repository implementation.

Authorized scope: static repository files and supplied redacted evidence for `governance-risk-compliance-assurance`.
...
2. Invoke the relevant Skill from: governance-policy-frameworks, risk-exceptions-remediation, assurance-third-party-reporting, independent-assurance-review.
3. Assign one primary owner from: governance-policy-frameworks-agent, cyber-risk-exceptions-agent, assurance-evidence-remediation-agent, third-party-maturity-reporting-agent, independent-assurance-reviewer.
