# junie Cybersecurity Defensive Security Operations, Detection, and Intelligence Instructions

These instructions apply only inside `junie/cybersecurity/defensive-security-operations-detection-intelligence/`.
