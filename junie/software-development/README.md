...
This directory implements the Software Development specialization for JetBrains Junie using only platform-appropriate, repository-scoped content.
...
- .junie/skills project Skills
- .aiignore context protection
...
- hooks
- MCP configuration
- Brave mode or automatic approvals
