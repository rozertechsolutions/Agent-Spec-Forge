...
## Skill and workflow use

Use `.junie/skills/` for reusable procedures. Use `docs/workflows/` as supporting checklists. Keep command execution under normal IDE approval; never assume Brave mode.
