...
Use `.claude/agents/` for exclusive role delegation and `.claude/skills/` for reusable procedures. Workflow documents under `docs/workflows/` are supporting references, not auto-executed commands.
