...
This directory implements the Software Development specialization for Claude Code using only platform-appropriate, repository-scoped content.
...
- .claude/settings.json project safety settings

## Manual or auxiliary content

- docs/workflows is supporting project documentation referenced by native instructions
...
- Claude web/desktop Project files
