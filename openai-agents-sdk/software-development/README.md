...
This directory implements the Software Development specialization for OpenAI Agents SDK using only platform-appropriate, repository-scoped content.
...
- typed evidence and workflow records
- inert host-injected tool interfaces

## Manual or auxiliary content

- tests are static source and were not executed
...
- installer
- API invocation
- shell/filesystem/network tools
- credentials or fixed model
