# qwen-code Cybersecurity Governance, Risk, Compliance, and Assurance Instructions

These instructions apply only inside `qwen-code/cybersecurity/governance-risk-compliance-assurance/`.
