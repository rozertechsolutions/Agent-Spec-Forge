# qwen-code Cybersecurity Application, Product, and DevSecOps Security Instructions

These instructions apply only inside `qwen-code/cybersecurity/application-product-devsecops-security/`.
