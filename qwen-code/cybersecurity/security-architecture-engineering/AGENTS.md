# qwen-code Cybersecurity Security Architecture and Engineering Instructions

These instructions apply only inside `qwen-code/cybersecurity/security-architecture-engineering/`.
