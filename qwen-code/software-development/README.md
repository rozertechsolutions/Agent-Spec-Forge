...
This directory implements the Software Development specialization for Qwen Code using only platform-appropriate, repository-scoped content.
...
- .qwen/agents subagents
- .qwen/skills Skills
- .qwen/commands prompt commands
