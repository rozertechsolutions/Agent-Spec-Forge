...
Enable only capabilities necessary for the current task. Browsing, data analysis, apps, connectors, and actions must remain disabled unless a human explicitly selects and authorizes them for a named task. Never place secrets in instructions or knowledge files.
