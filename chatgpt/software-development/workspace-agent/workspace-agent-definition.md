...
This is a source definition for a supported ChatGPT workspace administration surface. It is not an auto-loaded repository file. A workspace administrator must review role scope, data access, apps, connectors, and publication visibility before creating or enabling an agent.
