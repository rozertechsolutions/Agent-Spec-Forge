# local Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `local/cybersecurity/offensive-security-authorized-validation/`.
