# local Cybersecurity Cyber Resilience and Specialized Technologies Instructions

These instructions apply only inside `local/cybersecurity/cyber-resilience-specialized-technologies/`.
