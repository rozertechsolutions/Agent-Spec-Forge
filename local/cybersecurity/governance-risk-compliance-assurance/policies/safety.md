# local Cybersecurity Governance, Risk, Compliance, and Assurance Instructions

These instructions apply only inside `local/cybersecurity/governance-risk-compliance-assurance/`.
