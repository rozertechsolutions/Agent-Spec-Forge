# local Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `local/cybersecurity/incident-response-dfir-recovery/`.
