# local Cybersecurity Defensive Security Operations, Detection, and Intelligence Instructions

These instructions apply only inside `local/cybersecurity/defensive-security-operations-detection-intelligence/`.
