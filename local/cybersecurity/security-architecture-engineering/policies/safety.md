# local Cybersecurity Security Architecture and Engineering Instructions

These instructions apply only inside `local/cybersecurity/security-architecture-engineering/`.
