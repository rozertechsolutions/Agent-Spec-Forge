# local Cybersecurity Application, Product, and DevSecOps Security Instructions

These instructions apply only inside `local/cybersecurity/application-product-devsecops-security/`.
