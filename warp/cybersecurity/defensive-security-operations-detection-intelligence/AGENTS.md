# warp Cybersecurity Defensive Security Operations, Detection, and Intelligence Instructions

These instructions apply only inside `warp/cybersecurity/defensive-security-operations-detection-intelligence/`.
