# warp Cybersecurity Cyber Resilience and Specialized Technologies Instructions

These instructions apply only inside `warp/cybersecurity/cyber-resilience-specialized-technologies/`.
