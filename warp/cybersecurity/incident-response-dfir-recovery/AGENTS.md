# warp Cybersecurity Incident Response, DFIR, and Recovery Instructions

These instructions apply only inside `warp/cybersecurity/incident-response-dfir-recovery/`.
