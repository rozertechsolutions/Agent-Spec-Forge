# warp Cybersecurity Offensive Security Authorized Validation Instructions

These instructions apply only inside `warp/cybersecurity/offensive-security-authorized-validation/`.
